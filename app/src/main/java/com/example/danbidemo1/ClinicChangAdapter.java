...
//public class ClinicChangAdapter extends RecyclerView.Adapter<ClinicAdapter.ClinicViewHolder>{
//
//    private ArrayList<Clinic> arrayList;
//    private Context context;
//
//    public ClinicChangAdapter(ArrayList<Clinic> arrayList, Context context) {
...
//    @NonNull
//    @Override
//    public ClinicChangAdapter.ClinicChangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.clinic_item, parent, false);
//        ClinicChangAdapter.ClinicChangViewHolder holder2 = new ClinicChangAdapter.ClinicChangViewHolder(view);
//        return holder2;
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull ClinicAdapter.ClinicViewHolder holder, int position) {
